  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
            ...
            <a href="#top">
                <Image src={isDarkMode ? assets.alan_logo : assets.alan_logo} alt="" className='w-28 cursor-pointer mr-14'/>
            </a>
            ...
            <div className='flex items-center gap-4'>
                ...
                px-10 py-2.5 border border-gray-5 00 rounded-full ml-4 font-Ovo dark:border-white/50'>Contact
